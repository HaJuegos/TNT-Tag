...
import { TicksPerSecond, EntityQueryOptions, Entity, RGB, world } from "@minecraft/server";
 ...
 * @type {string[]}
 */
export const hideElements: string[] = [
    `hud @s hide health`,
    `hud @s hide hunger`,
 ...
 */
export function getAllEntitiesInAllDime(filters: EntityQueryOptions = {}): Entity[] {
 ...
 */
export function RGBFloatConvertor(colorHex: string): RGB {
 ...
 */
export function ticksConvertor(seconds: number): number {
