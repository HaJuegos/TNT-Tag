...
import { Player, ItemLockMode, ItemStack, InputPermissionCategory, world } from "@minecraft/server";
 ...
 * @returns {void} 
 */
export function companionHit(ply: Player): void {
 ...
 * @returns {void}
 */
export function netEvents(hitEntity: Player): void {
 ...
 * @returns {void}
 */
export function returnTnTItem(ply: Player): void {
