 ...
 * @type {TempStadictic}
 */
let tempStadistic: TempStadictic = {};
 ...
 * @returns {void}
 */
function showInfoPly(ply: mc.Player): void {
 ...
 * @return {void}
 */
function addOrRemoveObj(ply: mc.Player, obj: string, value: number): void {
 ...
 * @returns {void}
 */
function updateTempData(ply: mc.Player): void {
    const objs = {
    ...
    const getScore = (obj: mc.ScoreboardObjective | undefined, ply: mc.Player): number => {
        try {
