 ...
 * @type {TimerLoopBase}
 */
const inGameLoop: TimerLoopBase = {
    obj: "timerInGame",
 ...
 * @returns {void}
 */
function reasingroles(tntPlys: mc.Player[]): void {
 ...
 * @returns {void}
 */
function changeScoreboard(totalNormalPlys: number, totalTntPlys: number): void {
 ...
 * @returns {void}
 */
function newTNTPlayer(activePlayers: mc.Player[]): void {
