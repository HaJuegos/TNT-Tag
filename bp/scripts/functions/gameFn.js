...
function gameStarted(sourcePly) {
    ...
    const entity = mc.world.getDimension('overworld').spawnEntity('ha:votation_entity', { x: 2035, y: 53, z: -1977 });
 ...
 * @returns {void}
 */
function viewAndSetScoreboard(totalNormalPlys, totalTntPlys, timerEntity) {
