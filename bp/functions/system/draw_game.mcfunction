...
titleraw @a subtitle {"rawtext": [{"translate": "ui.drawparty_sub"}]}
titleraw @a title {"rawtext": [{"translate": "ui.drawparty"}]}

execute as @a at @s run playsound mob.wither.break_block
